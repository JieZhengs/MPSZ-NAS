...
if __name__ == '__main__':
    (train_loader, valid_loader) = get_train_valid_loader('../../datasets/RQ_data/train/', batch_size=100, augment=True, subset_size=1,
                                    valid_size=0.1, shuffle=True, num_workers=4,
                                    pin_memory=True)

    # train_loader = get_train_loader('../../datasets/RQ_data/train', batch_size=100, augment=True, shuffle=True,
    #                                 num_workers=4, pin_memory=True)
    #
    # valid_loader = get_test_loader('../../datasets/RQ_data/val', batch_size=100, shuffle=False, num_workers=4,
    #                                pin_memory=True)
